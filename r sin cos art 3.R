...
par(mfrow=c(1,4), ann=FALSE, pty='s', cex=0.2, mai=c(.05,.05,.05,.05), mar=c(0.1, 0.1, 0.1, 0.1), oma=c(0,0,0,0))
...
plot(sin(c%%abs(x)), cos(d/x), axes=FALSE, col=rgb(20, 22, 95, 85, max=255))
plot(sin(e/x), cos(d/x), axes=FALSE, col=rgb(20, 32, 75, 45, max=255))
